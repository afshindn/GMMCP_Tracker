...
%% Sequence Info
sequence_name = 'TUD_Crossing';
data_directory = './Data/';
im_directory = fullfile(data_directory,'Images',sequence_name);
images = dir(fullfile(im_directory,'*.jpg'));
load(fullfile(data_directory,'Detections',[sequence_name '.mat']));
...
if(exist(fullfile(param_tracklet.data_directory,'Features',['tracklets_' param_tracklet.seqName '_nf.mat']), 'file'))
